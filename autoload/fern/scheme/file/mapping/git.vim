...
function! fern#scheme#file#mapping#git#init(disable_default_mappings) abort
...
let g:fern#scheme#file#mapping#git#disable_default_mappings = get(g:, 'fern#scheme#file#mapping#git#disable_default_mappings', 0)
